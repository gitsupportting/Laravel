...
<div class="content-wrapper" data-simplebar style="background-color:#F1F1F1;">
    <section class="full-height certificate-card">
        <div class="certificate-card__header">
            <a href="{{route('course.showResults', $course)}}" class="btn btn-blue">Return to Course</a>
            <button onclick="printDiv()" class="btn btn-right btn-blue">Print Certificate</button>
        </div>
        <div id="DivIdToPrint">
                ...
                <table class="certificate-table" style="width: 100%; position: relative; z-index: 2;">
                    ...
                    <tr>
                        <td style="padding-top: 50px; padding-bottom: 50px; color: #053562; font-size: 14px; font-weight: 500; text-align: center;">
                            Course delivered via Correct Care <br> correctcare.co.uk
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <img style="display: block; margin: 0 auto; max-width:120px; width: auto; height: auto;" src ="https://correctcare.co.uk/wp-content/uploads/2020/01/CC.png">
                        </td>
                    </tr>
                    </tbody>
                </table>
